class BulletType2Controller extends BulletController {
  ...
  update() {
    var targetPoint = TP.enemyGroup.getFirstAlive();
    if (targetPoint == null) {
      targetPoint = {
    ...
    var targetAngle = TP.game.math.angleBetween(
    ...
    targetAngle += TP.game.math.degToRad(this.wobble);
    ...
    if (this.sprite.rotation !== targetAngle) {
      ...
      if (Math.abs(delta) < TP.game.math.degToRad(this.TURN_RATE)) {
